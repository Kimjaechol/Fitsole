...
- ~~오프라인 매장 운영~~ — v1에 오프라인 매장 소개 페이지 + 스마트 인솔 키트 포함 (scope 변경)
...
|----------|-----------|---------|
| 동영상 SfM 스캐닝 (사진 3장 → 동영상) | 6배 정확도 향상 (±0.15mm vs ±0.95mm) | — Pending |
| 보행 동영상 AI 분석 추가 | 하중 분배, 발목 정렬, 아치 유연성 추가 측정 | — Pending |
| 스마트 인솔 키트 (오프라인/운동선수 전용) | 정밀 측정 필수 고객 대응, AI 모델 재학습 데이터 확보 | — Pending |
| 오프라인 매장 소개 페이지 | 강남역 지하상가 매장, 스마트 인솔 키트 현장 측정 | — Pending |
