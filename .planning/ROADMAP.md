...
- [x] 05-05-PLAN.md — SALTED session viewer and offline store reservation management
**UI hint**: yes
...
- [x] 06-03-PLAN.md — Offline store: /stores/gangnam page, Kakao static map, reservation form + public POST /api/reservations, athlete kit rental section (OFFL-01/02/03/04)
**UI hint**: yes
